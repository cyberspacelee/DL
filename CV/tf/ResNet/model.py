...
class BasicBlock(layers.Layer):
    ...
    def __init__(self, out_channel, stride=1, downsample=None, **kwargs):
        ...
        self.conv1 = layers.Conv2D(out_channel, kernel_size=3, strides=stride, padding="SAME", use_bias=False)
...
class Bottleneck(layers.Layer):
    """
    注意：原论文中，在虚线残差结构的主分支上，第一个 1 x 1 卷积层的步距是 2，第二个 3 x 3 卷积层步距是 1
    但在 pytorch 官方实现过程中是第一个 1 x 1 卷积层的步距是 1，第二个 3 x 3 卷积层步距是 2
