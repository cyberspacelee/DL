...
class Inception(layers.Layer):
    def __init__(self, ch1x1, ch3x3red, ch3x3, ch5x5red, ch5x5, pool_obj, **kwags):
        super(Inception, self).__init__(**kwags)
        ...
        self.branch4 = Sequential([
            ...
            layers.Conv2D(pool_obj, kernel_size=1, activation='relu')
        ])
