...
def main():
    ...
    net = resnet34()
    # load pretrian weights
    # download url: https://download.pytorch.org/models/resnet34-333f7ec4.pth
    model_weight_path = './model/resnet34-333f7ec4.pth'
    assert os.path.exists(model_weight_path), "cannot find {}".format(model_weight_path)
    ...
    for epoch in range(epochs):
        # train
        net.train()
        # net.train() / net.eval() BatchNormalization
        running_loss = 0.0
